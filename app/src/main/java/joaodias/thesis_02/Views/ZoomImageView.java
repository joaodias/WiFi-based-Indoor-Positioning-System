...
/**
 * Created by joaodias on 10/3/15.
 */
...
public class ZoomImageView extends ImageView {
    ...
    public void updateImageView(float[] coords){
        Map _map = Map.getInstance();

        _map.setTouched_width(coords[0]);
        _map.setTouched_height(coords[1]);
        ...
        tempCanvas.drawCircle(coords[0], coords[1], 10, paint);
    ...
    public void updateImageViewFix(){
        Map _map = Map.getInstance();

        Bitmap myBitmap = _map.getCurImage();
        Bitmap tempBitmap = Bitmap.createBitmap(myBitmap.getWidth(), myBitmap.getHeight(), Bitmap.Config.RGB_565);
        Canvas tempCanvas = new Canvas(tempBitmap);
        ...
        tempCanvas.drawCircle(_map.getTouched_width(), _map.getTouched_height(), 10, paint);

        _map.setBaseImage(tempBitmap);
        _map.setIsPoint(false);
    ...
    public boolean onTouchEvent(final MotionEvent event) {
        ...
        switch (actionCode) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                resetColorFilter();
                if(prev_state) {
                    float[] coords = getPointerCoords(this, event);
                    updateImageView(coords);
                }
